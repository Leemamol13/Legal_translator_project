...
def process_dataset(input_csv: str, glossary_csv: str, output_csv: str, sample_size: int = 10):
    ...
    for _, row in df.iterrows():
        ...
        bleu_ctx, meteor_ctx, comet_ctx = evaluate_metrics(source, candidate, reference)

        # Evaluation for scenario 2
        bleu_def, meteor_def, comet_def = evaluate_metrics(source, candidate, reference)
